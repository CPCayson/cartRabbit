...
class _EditCartWidgetState extends State<EditCartWidget> {
  ...
  void initState() {
    ...
    _model.switchValue1 = FFAppState().CARTS[widget.cartID!].isElectric;
    _model.switchValue2 = FFAppState().CARTS[widget.cartid!].air;
    _model.switchValue3 = FFAppState().CARTS[widget.cartid!].isElectric;
    _model.switchValue4 = FFAppState().CARTS[widget.cartid!].storage;
                                    ...
                                    child: Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: TextFormField(
                                          ...
                                          focusNode: _model.cartNameFocusNode,
                                  ...
                                  Expanded(
                                    child: Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: TextFormField(
                                          controller:
                                              _model.tagNumberTextController,
                                          focusNode: _model.tagNumberFocusNode,
                                          autofillHints: [AutofillHints.name],
                                          textCapitalization:
                                              TextCapitalization.words,
                                          obscureText: false,
                            ...
                            onPressed: () async {
                              FFAppState().updateCARTSAtIndex(
                                ...
                                (e) => e
                                  ...
                                  ..cartCapacity = _model.countControllerValue
                              ...
                              setState(() {});
                              await AuthorizationGroup.updateProductCall.call(
                                name: FFAppState()
                                    .CARTS[widget.cartid!]
                                    .cartDisplayName,
                                product: FFAppState()
