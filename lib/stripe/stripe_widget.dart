                ...
                child: Column(
                  ...
                  children: [
                    FFButtonWidget(
                      onPressed: () async {
                        _model.apiResulthjx =
                            await AuthorizationGroup.accountsCall.call();
                        if ((_model.apiResulthjx?.succeeded ?? true)) {
                          _model.apiResulte14 = await AuthorizationGroup
                              .createAccountLinkCall
                              .call();
                          if ((_model.apiResulte14?.succeeded ?? true)) {
                            setState(() {
                              FFAppState().link =
                                  AuthorizationGroup.createAccountLinkCall.url(
                                (_model.apiResulte14?.jsonBody ?? ''),
                              )!;
                            });
                            await launchURL(FFAppState().link);
                          } else {
                    ...
                    FFButtonWidget(
                      ...
                      text: 'Buy product from marketplace',
                      options: FFButtonOptions(
                        height: 40.0,
