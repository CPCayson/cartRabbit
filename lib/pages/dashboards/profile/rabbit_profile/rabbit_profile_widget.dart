...
import 'rabbit_profile_model.dart';
export 'rabbit_profile_model.dart';

class RabbitProfileWidget extends StatefulWidget {
  const RabbitProfileWidget({Key? key}) : super(key: key);

  @override
  _RabbitProfileWidgetState createState() => _RabbitProfileWidgetState();
}

class _RabbitProfileWidgetState extends State<RabbitProfileWidget>
    with TickerProviderStateMixin {
  late RabbitProfileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RabbitProfileModel());
    ...
    _model.yourAgeController ??= TextEditingController(
        text: dateTimeFormat('d/M/y', currentUserDocument?.age));
