...
import 'cancel_host_model.dart';
export 'cancel_host_model.dart';

class CancelHostWidget extends StatefulWidget {
  const CancelHostWidget({
    Key? key,
    this.tripDetails,
  }) : super(key: key);
  ...
  @override
  _CancelHostWidgetState createState() => _CancelHostWidgetState();
}

class _CancelHostWidgetState extends State<CancelHostWidget> {
  late CancelHostModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CancelHostModel());
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: /* NOT RECOMMENDED */
                          _model.emailAddressController.text == 'true'
                              ? null
                              : () async {
