...
import 'higgg_model.dart';
export 'higgg_model.dart';

class HigggWidget extends StatefulWidget {
  const HigggWidget({super.key});

  @override
  State<HigggWidget> createState() => _HigggWidgetState();
}

class _HigggWidgetState extends State<HigggWidget> {
  late HigggModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HigggModel());
              ...
              Padding(
                ...
                child: StreamBuilder<List<CartsRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<CartsRecord> checkoutBottomSheetCartsRecordList =
                        snapshot.data!;
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: custom_widgets.TimeWidget(
                                  width: MediaQuery.sizeOf(context).width * 1.0,
                                  height: 80.0,
                                  textbutton: 'hi',
                                  textColorbutton:
