...
class HostPageWidget extends StatefulWidget {
  const HostPageWidget({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<CartsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CartsRecord> hostPageCartsRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final hostPageCartsRecord = hostPageCartsRecordList.isNotEmpty
            ? hostPageCartsRecordList.first
            : null;
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              leading: FlutterFlowIconButton(
                ...
                borderWidth: 1.0,
                buttonSize: 60.0,
                hoverColor: Color(0xFF3996EF),
                icon: Icon(
                  Icons.arrow_back_rounded,
                  color: Color(0xFF33BBAB),
                  size: 30.0,
                ),
                                        ...
                                        child: Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  4.0, 4.0, 16.0, 0.0),
                                          child: Text(
                                            hostPageCartsRecord!.description,
                                            style: FlutterFlowTheme.of(context)
                                                .labelMedium,
                                          ),
                                        ),
                              ...
                              child: Row(
                                ...
                                children: [
                                  ClipRRect(
                                    ...
                                    child: Image.asset(
                                      'assets/images/Screenshot_2023-08-02_071103.png',
                                      width: 90.0,
                                      height: 90.0,
                                      fit: BoxFit.cover,
                                    ),
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 8.0, 0.0, 0.0),
                                          child: Text(
                                            hostPageCartsRecord!.ownersName,
                                            style: FlutterFlowTheme.of(context)
                                                .bodyLarge,
                                          ),
                                        ),
                                        Row(
                                          ...
                                          children: [
                                            Text(
                                              hostPageCartsRecord!.isAvailable
                                                  .toString(),
                                              style:
