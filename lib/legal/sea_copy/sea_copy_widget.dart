...
import 'sea_copy_model.dart';
export 'sea_copy_model.dart';

class SeaCopyWidget extends StatefulWidget {
  const SeaCopyWidget({super.key});

  @override
  State<SeaCopyWidget> createState() => _SeaCopyWidgetState();
}

class _SeaCopyWidgetState extends State<SeaCopyWidget>
    with TickerProviderStateMixin {
  late SeaCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SeaCopyModel());
                                          ...
                                          builder: (context) =>
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                FutureBuilder<List<BsllRow>>(
                                                  future: BsllTable().queryRows(
                                                    queryFn: (q) => q,
                                                  ),
                                                                ...
                                                                children: [
                                                                  Expanded(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                          Text(
                                                                        'Rabbit Review ${listViewBsllRow.rating?.toString()}',
