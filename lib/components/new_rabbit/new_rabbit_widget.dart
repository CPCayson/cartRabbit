...
import 'new_rabbit_model.dart';
export 'new_rabbit_model.dart';

class NewRabbitWidget extends StatefulWidget {
  const NewRabbitWidget({super.key});

  @override
  State<NewRabbitWidget> createState() => _NewRabbitWidgetState();
}

class _NewRabbitWidgetState extends State<NewRabbitWidget>
    with TickerProviderStateMixin {
  late NewRabbitModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NewRabbitModel());

    _model.yourNameTextController ??=
        TextEditingController(text: FFAppState().APPUSER.userDisplayName);
    _model.yourNameFocusNode ??= FocusNode();

    _model.yourAgeTextController ??=
        TextEditingController(text: FFAppState().APPUSER.userAge?.toString());
    _model.yourAgeFocusNode ??= FocusNode();

    _model.yourEmailTextController ??=
        TextEditingController(text: FFAppState().APPUSER.userEmail);
    _model.yourEmailFocusNode ??= FocusNode();

    _model.bioTextController ??=
        TextEditingController(text: FFAppState().APPUSER.userShortDescrip);
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                ...
                                validator: _model.yourAgeTextControllerValidator
                                    .asValidator(context),
                                inputFormatters: [_model.yourAgeMask],
                              ),
                            ),
                          ),
                          Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Align(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  _model.cid = await actions.createCustomer(
