...
import 'user_t_model.dart';
export 'user_t_model.dart';

class UserTWidget extends StatefulWidget {
  const UserTWidget({super.key});

  @override
  State<UserTWidget> createState() => _UserTWidgetState();
}

class _UserTWidgetState extends State<UserTWidget>
    with TickerProviderStateMixin {
  late UserTModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserTModel());
