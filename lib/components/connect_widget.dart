...
import '/pages/dashboards/user/cancel_user/cancel_user_widget.dart';
          ...
          Padding(
            ...
            child: StreamBuilder<List<BookingsRecord>>(
              ...
              builder: (context, snapshot) {
                ...
                List<BookingsRecord> buttonBookingsRecordList = snapshot.data!;
                // Return an empty Container when the item does not exist.
                if (snapshot.data!.isEmpty) {
                  return Container();
                }
                final buttonBookingsRecord = buttonBookingsRecordList.isNotEmpty
