                                                                    ...
                                                                    children: [
                                                                      Align(
                                                                        ...
                                                                        child:
                                                                            Text(
                                                                          '${formatNumber(
                                                                            functions.cartDist(currentUserLocationValue,
                                                                                cartsCartsRecord.cartLoc),
                                                                            formatType:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      children: [
                                                                        AmenitityIndicatorWidget(
                                                                          key: Key(
                                                                              'Key0i5_${cartsIndex}_of_${cartsCartsRecordList.length}'),
                                                                          icon:
                                                                              Icon(
                                                                          ...
                                                                          background: cartsCartsRecord.air
                                                                              ? FlutterFlowTheme.of(context).turquoise
                                                                ...
                                                                AlignedTooltip(
                                                                  ...
                                                                  child: Column(
                                                                    ...
                                                                    children: [
                                                                      AmenitityIndicatorWidget(
                                                                        key: Key(
                                                                            'Keyprx_${cartsIndex}_of_${cartsCartsRecordList.length}'),
                                                                        icon:
                                                                            Icon(
                                                                          Icons
                                                                        ...
                                                                        background: cartsCartsRecord.storage
                                                                            ? FlutterFlowTheme.of(context).turquoise
                                                                            : FlutterFlowTheme.of(context).accent3,
                                                                        borderColor:
                                                                            FlutterFlowTheme.of(context).primaryBackground,
                                                                ...
                                                                AlignedTooltip(
                                                                  ...
                                                                  child: Column(
                                                                    ...
                                                                    children: [
                                                                      AmenitityIndicatorWidget(
                                                                        key: Key(
                                                                            'Keygb4_${cartsIndex}_of_${cartsCartsRecordList.length}'),
                                                                        icon:
                                                                            Icon(
                                                                          Icons
                                                                              .audiotrack,
                                                                        ...
                                                                        background: cartsCartsRecord.radio
                                                                            ? FlutterFlowTheme.of(context).turquoise
                                                                            : FlutterFlowTheme.of(context).accent3,
                                                                        borderColor:
                                                                            FlutterFlowTheme.of(context).primaryBackground,
                                                                ...
                                                                AlignedTooltip(
                                                                  ...
                                                                  child: Column(
                                                                    ...
                                                                    children: [
                                                                      AmenitityIndicatorWidget(
                                                                        key: Key(
                                                                            'Keyun2_${cartsIndex}_of_${cartsCartsRecordList.length}'),
                                                                        icon:
                                                                            Icon(
                                                                          Icons
                                                                              .local_gas_station,
                                                                ...
                                                                AlignedTooltip(
                                                                  ...
                                                                  child: Column(
                                                                    ...
                                                                    children: [
                                                                      AmenitityIndicatorWidget(
                                                                        key: Key(
                                                                            'Keyvo8_${cartsIndex}_of_${cartsCartsRecordList.length}'),
                                                                        icon:
                                                                            Icon(
                                                                          Icons
                                                                              .electric_bolt,
