        ...
        https.get(url, (res) => {
            ...
            res.on('end', () => {
                ...
                try {
                  ...
                  reject(new functions.https.HttpsError('unknown', 'Failed to process the response'));
              }
            ...
            reject(new functions.https.HttpsError('internal', 'Unable to call Google Directions API'));
        });
    });
});
